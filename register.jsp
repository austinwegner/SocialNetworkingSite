...
Enter you email address: <input type="text" name="email"></br>
Enter your username: <input type="text" name="username"></br>
Select your gender:</br> <input type="radio" name="gender" value=Male />Male
		    <input type="radio" name="gender" value=Female />Female</br>
Select your birthday:</br> <select name="dobMonth">
			<option>Month</option>
